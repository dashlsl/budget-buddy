package com.example.budgetbuddy.ui.screen.home
...
import com.example.budgetbuddy.ui.screen.expense.AddExpenseScreen
import com.example.budgetbuddy.ui.screen.expense.DetailExpenseScreen
import com.example.budgetbuddy.ui.util.ConvertDecimal
import com.example.budgetbuddy.ui.util.DateConverter
import com.example.budgetbuddy.ui.util.MainViewModel
import com.example.budgetbuddy.ui.util.TabsList
import com.example.budgetbuddy.ui.util.TabsMap
...
fun SummaryBox(tabIndex:Int, expenseList: State<List<Expense>>){
    ...
    Column(
        ...
        Text(
            text = "Total Spent ${TabsMap[tabIndex]!!}",
            color = Color.White,
            fontSize = 16.sp,
        ...
        Row(
            ...
            Row(verticalAlignment = Alignment.CenterVertically, modifier = Modifier.fillMaxHeight()) {
                ...
                Column {
                    ...
                    Text(
                        text = TimeConverter(expense.time),
                        color = Color.Gray,
                        fontWeight = FontWeight.Medium
                    )
                }
