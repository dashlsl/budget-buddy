...
import com.example.budgetbuddy.data.ExpenseRepository
import com.example.budgetbuddy.data.Graph
import com.example.budgetbuddy.data.OnBoardingRepository
import com.example.budgetbuddy.ui.screen.expense.ConfirmDeleteDialog
...
class MainViewModel(
    ...
    fun onStateChange(amount: Int? = null, desc: String? = null, category: String? = null, date: Long? = null, time: Long? = null) {
